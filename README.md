...
Yukarıdaki örneği kullanarak **kendi ölçümlerinizle** bir tablo oluşturun (Aşağıda yeni bir tablo oluşturun ve yukarıdaki tabloya 3-4 tane kendi ölçümünü ekleyiniz.) Kullandığınız Google Sheet için [buraya](https://docs.google.com/spreadsheets/d/1ApNzmK8ZcFV8u6K8l13KFfpulHNfU7A_hrAJvDw7540/edit#gid=0) link verin (Google Sheet herkese açık erişimli olsun.) 

a) Denkleminizi **buraya yazınız=0,117+1,73x+1.14x^2**. Sizce a, b, ve c'nin fiziksel anlamları ne olabilir? (Yardım: bir tanesi ivme ile ilgili, bir tanesi ilk hız ile, diğeri konum ile ilgili).  Sizce niçin a'nın değeri negatif? **2. dereceden denklemlerin grafiği paraboldür. parabollerde de a "-" ise kollar bizdeki gibi aşağı doğru olur. sebebi budur.

b) Hava sürtünmesini ihmal edersek, bu harakette ivme sabit midir? **cisim hızlanma ve yavaşlama gerçekleştiriyor ivmede vektörel olduğu için bu harekette ivme sabit değildir.

c) Video'daki cismin atılış hızı farklı olsaydı (diğer herşey aynı, kütle, yüzey, vb. Hava sürtünmesini ihmal edin), sizce formülde hangi terimler değişecekti? (a, b veya c) **daha hızlı atılsaydı a küçülür c artar, b de hızla orantılıdır.
...
1) Kendi aldığınız verileri kullanarak **ortalama hız-zaman** grafiğini Google çiziniz. [Buraya](https://docs.google.com/spreadsheets/d/1Cs6kkqNVorTsuQjjeQGVEthFXRUXOCzqYHn-UbFIZk0/edit#gid=0) link veriniz.
...
# Bölüm 3 (Hala Beni Öldürmeyi Düşünmüyorsan) yok ya :) 
1) Bu deneyde ölçüm hatalarım var. Zamandaki ölçüm hatam sizce kaç ms (mili saniye) nedir? Konumdaki ölçüm hatam sizce kaç cm'dir? **2 cm buldum.**ben 2 cm buldum.

2) Acaba hiç grafik çizmeden sürtünme katsayısını bulabilir miydim?  (Cevap: Evet). 
Yardım: **uyguladığımız kuvveti bilseydik olurdu.** 
